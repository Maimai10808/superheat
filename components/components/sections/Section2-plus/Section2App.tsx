   ...
   <div className="bg-[url('/images/Section2App.png')] bg-no-repeat bg-[length:40%] bg-[position:60%_100%]  h-screen flex items-center px-10">
      ...
      <div className="max-w-screen-xl pl-40 w-full flex">
        ...
        <div className="flex flex-col justify-center space-y-4 w-1/3">
          ...
          <p className="section2-subtitle">
            The SuperHeat App connects your heater,
             your energy, and your earnings — all in one
              ...
              earnings, it turns every moment of heating into
              an intelligent, measurable experience.
          </p>
          ...
          <Link href='' className='' >Earnings</Link>
          <Link href='' className=''>Device Control</Link>
          </div>
