...
function Video() {
  return <div className='w-full h-[300px] relative overflow-hidden'>
    <Image
...
function MainTitle() {
    return <div className='flex flex-col  px-5 items-center mt-20 w-full'>
  {/* Main Title */}
...
function Start() {
  return <div className='w-2/5 flex flex-col justify-center items-center mt-20'>
    {/* Start-title */}
...
function Roadmap() {
  return <div className='flex flex-col justify-center items-center px-10 my-20'>
    {/* Roadmap-title */}
...
function Utility() {
  return <div className='mt-[300px] w-4/5 '>
