...
export default function Section4Web() {
  return (
...
Confident Decisions.
          ...
          <p className="font-section4-subtitle">
           Visualized revenue data and granular permissions ensure both clarity and security —
           enabling better financial control at every level.
          </p>
