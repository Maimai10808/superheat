...
export default function Hero() {
  ...
  return (<div className="bg-[url('/images/section1background.jpg')] bg-cover bg-center h-screen flex items-end justify-center px-6 py-20">
           ...
           <div className="w-full  px-4 flex justify-between items-end text-white  pb-20">
            ...
            <p className='font-geist text-white font-light text-[24px] leading-[110%] tracking-[-5%] text-right align-middle '>
               Heating the future.<br />
               Powered by silicon.<br />
               Earned in blocks.
            </p>
            </div>
      </div>
