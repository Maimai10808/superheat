      ...
      <div className="max-w-screen-xl pl-40 w-full flex ">
        ...
        <div className="flex flex-col justify-center  space-y-4 w-1/3">
          ...
          <p className="font-section2-subtitle">
            Superheat Console provides a centralized platform to monitor, configure, and optimize all connected devices.
            Designed for enterprise scenarios, it simplifies cluster management, enhances collaboration, and delivers
            real-time operational insights — all in one clean interface.
          </p>
