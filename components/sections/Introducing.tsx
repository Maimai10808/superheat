import Section2App from "@/components/sections/Section2-plus/Section2App";
import Section2Web from "@/components/sections/Section2-plus/Section2Web";
import Section2Products from "@/components/sections/Section2-plus/Section2Products";
  ...
  return (
    <div className="w-full px-4 flex flex-col justify-center items-center text-white pb-40 space-y-4">
      ...
      <p className="font-geist font-normal text-[36px] leading-[0.95] tracking-[-0.05em] text-center text-[rgba(255,255,255,0.6)] p-2">
        More than a heater — it’s an intelligent
        <br /> energy ecosystem.
      </p>
